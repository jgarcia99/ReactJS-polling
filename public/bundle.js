...
/***/ function(module, exports, __webpack_require__) {
	...
	/*being passed from app down to join*/
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Join = React.createClass({
	    ...
	    join: function join() {
	        //ref has access to the whole name object in form
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement('input', { className: 'form-control', type: 'text', placeholder: 'enter your full name...', ref: 'name', required: true }),
	            React.createElement(
	                'button',
